...
int timer_init(tim_t dev, unsigned long freq, timer_cb_t cb, void *arg)
{
    ...
    //    return -1;
    //}
    // Well, that comment seems to just be a lie -Pat
 ...
 * GCLK1 (8MHz) if we use the PLL */
    ...
    // 13.8.3 p101
    // Each register write
    //   Chooses to enable the generic clock in quesiton
    //   Selects a generic clock
    //   Ties a peripheral to the selectec generic clock
